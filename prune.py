...
def prune_list(gaussians, scene, pipe, background, kernel_size, mip, subpixel_offset=None):
    viewpoint_stack = scene.getTrainCameras().copy()
    gaussian_list, imp_list = None, None
    viewpoint_cam = viewpoint_stack.pop()
    render_pkg = count_render(viewpoint_cam, gaussians, pipe, background, kernel_size=kernel_size, mip=mip, subpixel_offset=subpixel_offset)
